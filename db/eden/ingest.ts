...
import * as Stats from './../../src/bonuses/stats';
import * as Resists from './../../src/bonuses/resistance';
import * as Focuses from './../../src/bonuses/focus';
import * as Skills from './../../src/bonuses/skill';
import * as Classes from './../../src/constants/classes';
import {Bonus} from '../../src/bonuses';

const DB = 'db/eden/items.sqlite3';
const SCHEMA = 'db/create_schema.sql';
...
const insertItems = db.transaction(
  (
    ...
    class_lookup: Map<Classes.Class, Number>,
